...
export const AverageTicket: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const NoShow: React.FC<IconProps> = (props) => ( 
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path>
        <circle cx="9" cy="7" r="4"></circle>
...
export const FileCheck2: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path>
        <polyline points="14 2 14 8 20 8"></polyline>
...
export const PixLogo: React.FC<IconProps> = (props) => (
    // Serve a local pix image from the public folder (using the uploaded pix_icon.png).
    <img src="/pix_icon.png" alt="Pix" width={24} height={24} {...(props as any)} />
);
...
export const EyeOff: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a21.46 21.46 0 0 1 5.06-6.06" />
        <path d="M1 1l22 22" />
...
export const TicketPercent: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M15 5.76V2.21a2 2 0 0 0-3.33-1.6C10.5 1.55 9 3.45 9 5.76V8"></path>
        <path d="M9 8h11.41a2 2 0 0 1 1.95 2.45l-1.63 7.3A2 2 0 0 1 18.79 19H9"></path>
        <path d="M9 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"></path>
        <path d="M5.99 12.5a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1Z"></path>
        <path d="M5.99 15.5a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1Z"></path>
        <path d="M3 8h2.24a2 2 0 0 1 1.95 2.45l-1.63 7.3A2 2 0 0 1 3.62 19H3"></path>
    </svg>
);
...
export const Palette: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.667 0-.424-.163-.833-.436-1.152-.273-.319-.66-.581-1.212-.581h-1.648c-1.31 0-2.348-1.436-2.348-3.167 0-1.73 1.038-3.167 2.348-3.167h1.648c.926 0 1.648-.746 1.648-1.667S12.926 2 12 2z"></path>
  </svg>
);
